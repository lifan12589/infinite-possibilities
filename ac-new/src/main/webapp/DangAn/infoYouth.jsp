...
<html lang="zh">
	...
	<body>
		...
		<script>
			...
			function Jump(){
				//跳人脸
//				window.location.href =  webroot+"/netapply/apply/dangAnFace.do?ArchivesType=03";
//				window.location.href =  "./educatedYouth.jsp";
				window.location.href = "https://zwdtuser.sh.gov.cn/uc/naturalUser/jump.do?redirect_uri=http://localhost:8080/netapply/apply/faceEnter.do?link_uri=http://localhost:8080/dangAn/Index.do?ArchivesType=03";
			}

...
public class RSAUtils {
	...
	public static void main(String[] args) throws Exception {
		//Map<String, String> keyPairMap = createKeys(520);
		//String publicKey = Config.get("rsa.publicKey");
		//String privateKey = Config.get("rsa.privateKey");
		//String publicKey = keyPairMap.get("publicKey");
		//String privateKey = keyPairMap.get("privateKey");
		String publicKey ="MF0wDQYJKoZIhvcNAQEBBQADTAAwSQJCAJLYRPpPkeLd5ytMEPxooGklt0Dx18E2vZnGx0ywGAKgvKE3pJZi7HVsqOwEC6b_uj1F1TwzFRnIMeaH4ZUp69RJAgMBAAE";
		String privateKey ="MIIBWAIBADANBgkqhkiG9w0BAQEFAASCAUIwggE-AgEAAkIAkthE-k-R4t3nK0wQ_GigaSW3QPHXwTa9mcbHTLAYAqC8oTeklmLsdWyo7AQLpv-6PUXVPDMVGcgx5ofhlSnr1EkCAwEAAQJBeV3SNOgK9WzeIUTvTQ7UddM8UKsR3Zl2v2AxXMq2LYXD9E3-inQliANcDAkUY1lwQ1xuHI0n-srw0RgLYTMvH1kCIQ2r7QAGVA4OIzM-90AdjiRegbPifrmK-WOvvqhfHzI9owIhCr2qD6DSzHZGN5rSBJSKqh95YgwwS5o2albrkkQV5W0jAiED1Y_mTeANARIGMUaOiLtwn8CofoEj8EH5HzTNa8AICxkCIQKvvcF68D7Dtnxh9PXAUY6LoMitU8cVI1cltnY3IWLpEQIhAcaJb80TZkgUMOAVORO08CIva-IDT2JLj8XKPC92n3xO";
		...
		Date date = sdf.parse(decodedData);

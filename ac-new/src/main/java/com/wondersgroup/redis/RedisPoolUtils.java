package com.wondersgroup.redis;
...
public class RedisPoolUtils {
	 ...
	 *            端口
	 */
	public RedisPoolUtils(String ip, int prot, String auth) {
		if (pool == null) {
			JedisPoolConfig config = new JedisPoolConfig();
	 ...
	 *            超时时间
	 */
	public RedisPoolUtils(JedisPoolConfig config, String ip, int prot, int timeout) {
		if (pool == null) {

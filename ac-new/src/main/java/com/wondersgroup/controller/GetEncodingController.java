...
//		JSONObject json = getData("http://172.16.125.26:8080/ac-product-net/yb/getString2.do",new String( data.getBytes("UTF-8")));
...
//		JSONObject imp = sendBytes("http://172.16.125.26:8080/ac-product-net/yb/getByte2.do", str.getBytes("UTF-8"));

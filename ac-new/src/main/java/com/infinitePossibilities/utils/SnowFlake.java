package com.infinitePossibilities.utils.SnowFlakeId;
...
public class SnowFlake {
    ...
    public static void main(String[] args) {
        for(int i=0;i<60;i++){
            ...
            int number = 0;
        try{
            String insertSql = "INSERT INTO xuehua (id,name) values (?,?)";
            Object[] insertObject = new Object[] {userId,null};
            RecordSet rs  = SQL.execute(insertSql,insertObject);
            number = rs.TOTAL_RECORD_COUNT;
        }catch (Exception e){
            //影响行数

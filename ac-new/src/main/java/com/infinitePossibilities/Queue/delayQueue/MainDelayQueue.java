...
public class MainDelayQueue  {
    ...
    public static void pushMsg(int priority, String msg, long sendTimeMs) throws InterruptedException {
        System.out.println(String.format("消息%s进入队列时间："+Calendar.getInstance().getTimeInMillis(),priority));
    ...
    public static void main(String[] args) throws InterruptedException {
        for (int i = 5; i >= 1; i--) {
            ...
            MainDelayQueue.pushMsg(i, msg, Calendar.getInstance().getTimeInMillis() + i * 8000);
        }
    }
}
